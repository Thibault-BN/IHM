...
# Generated by qmake (2.01a) (Qt 4.7.4) on: jeu. mai 10 19:04:50 2012
...
SOURCES       = main.cpp \
		...
		stack.cpp \
		mouvement.cpp \
		savedboard.cpp moc_mainwindow.cpp \
		moc_board.cpp \
		qrc_res.cpp
OBJECTS       = main.o \
		mainwindow.o \
...
mouvement.o: mouvement.cpp mouvement.h \
		card.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mouvement.o mouvement.cpp
